...
export const TRAITS: readonly TraitDef[] = [
  ...
  },
  {
    ...
    breakpoints: [2, 4],
    effectText: [
      '护甲 +22，木石之躯：受到的反弹伤害降低 65%；每 5 秒永久获得 10% 攻速（可叠加）。',
      '护甲 +22，木石之躯：受到的反弹伤害降低 65%；构装体魔抗 +10；每次攻击叠加 12% 攻速（最多 8 层）；每第 4 次攻击额外造成 180% 攻击力的物理伤害。',
    ],
    colors: [1, 2],
  },
  {
  ...
  // ─────────────── 职业羁绊 (class) ───────────────
  {
    ...
    effectText: [
      ...
      '攻击力 +75%；每次攻击命中叠加 2.5% 攻击力（最多 10 层）；受到的物理伤害降低 18%。',
    ],
    colors: [0, 1, 2],
  },
  {
    ...
    effectText: [
      ...
      '生命 +28%，护甲 +32，攻击力 +15%；战斗开始时为相邻友军提供 12% 最大生命护盾；每 3 秒为自身提供 1.4% 最大生命护盾，受到物理伤害时反弹 52% 基础护甲值的伤害。',
    ],
    colors: [0, 1, 2],
  },
  {
