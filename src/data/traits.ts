...
export const TRAITS: readonly TraitDef[] = [
  // ─────────────── 地域羁绊 (origin) ───────────────
  {
    ...
    effectText: [
      ...
      '战斗开始时，天庭棋子获得 24% 最大生命的护盾；护盾被打破时对周围 1 格敌人造成 160% 法强的法术伤害。',
    ],
    colors: [1, 2],
  },
  {
    ...
    effectText: [
      ...
      '友军阵亡时，为最近的友军回复阵亡棋子 6% 的最大生命；幽冥棋子首次阵亡时以 10% 生命复活，并获得 30% 攻速加成直至战斗结束，复活后 4 秒内受到的伤害增加 35%。',
    ],
    colors: [1, 2],
  },
  {
  ...
  },
  {
    ...
    effectText: [
      '暴击率 +20%。',
      '暴击率 +20%；暴击伤害 +20%，剑宗无视目标 18% 护甲，全队无视 20% 护甲；击杀敌人后立即回复 20 点法力。',
    ],
    colors: [1, 2],
  },
  {
  ...
  },
  {
    ...
    effectText: [
      ...
      '护甲 +22；构装体魔抗 +10；每次攻击叠加 12% 攻速（最多 8 层）；每第 4 次攻击额外造成 180% 攻击力的物理伤害。',
    ],
    colors: [1, 2],
  },
  {
  ...
  },
  {
    ...
    effectText: [
      '龙渊棋子法强 +30。',
      '龙渊棋子法强 +30，技能伤害 +32%；全队法强 +18、技能伤害 +9%；施法后 4 秒内，下一次普攻额外造成 80% 法强的法术伤害。',
    ],
    colors: [1, 2],
  },

  {
    ...
    effectText: [
      ...
      '墨门棋子获得 10% 全伤害减免与 10% 最大生命；所有友军获得 8% 全伤害减免；墨门棋子每秒回复 1.8% 最大生命。',
      '墨门棋子获得 20% 全伤害减免与 10% 最大生命；所有友军获得 8% 全伤害减免；墨门棋子每秒回复 1.8% 最大生命；兼爱：友军受到的伤害有 30% 转由全体墨门棋子均摊。',
    ],
    colors: [0, 1, 2],
  },
  {
    ...
    effectText: [
      '兵家棋子攻击力 +20%。',
      '兵家棋子攻击力 +20%；所有友军攻击力 +22%、攻速 +17%；攻击护甲 55 以上的目标时，附带 15% 攻击力的额外物理伤害。',
      '兵家棋子攻击力 +20%；所有友军攻击力 +22%、攻速 +17%；攻击护甲 55 以上的目标时，附带 15% 攻击力的额外物理伤害；百战：任意友军击杀敌人时，全体友军永久 +26% 攻击力与 +18% 攻速，兵家棋子完成击杀时永久 +52% 攻击力与 +36% 攻速。',
    ],
    colors: [0, 1, 2],
  },
  ...
  },
  {
    ...
    effectText: [
      ...
      '生命 +28%，护甲 +32，攻击力 +15%；每 3 秒为自身提供 1.4% 最大生命护盾，受到物理伤害时反弹 52% 基础护甲值的伤害。',
    ],
    colors: [0, 1, 2],
  },
  {
    ...
    effectText: [
      ...
      '战斗开始 1 秒后跃入敌方最后排，落地后获得 0.7 秒无敌；暴击率 +20%、暴击伤害 +35%，跃入后 5 秒内获得 35% 攻速；跃入落定后立即突袭最近的敌人，造成其 12% 最大生命的物理伤害（不受伤害分摊）；对持有护盾的目标，攻击附带其 5% 最大生命的物理伤害。',
    ],
    colors: [1, 2],
  },
  {
  ...
  },
  {
    ...
    effectText: [
      '法强 +24。',
      '法强 +46；技能命中使目标魔抗 -20（4 秒）；全队法强 +14、技能伤害 +6%；开战全体获得 16% 最大生命护盾。',
      '法强 +78；技能命中使目标魔抗 -20（4 秒）；对目标周围 1 格造成 55% 溅射伤害；全队法强 +24、技能伤害 +11%；开战全体获得 22% 最大生命护盾。',
    ],
    colors: [0, 1, 2],
  },
  {
  ...
  },
  {
    ...
    effectText: [
      '全体友军每秒回复 1.2% 最大生命。',
      '全体友军每秒回复 1.2% 最大生命；丹师棋子的治疗与护盾效果 +80%；友军阵亡时，其余友军获得 20% 攻速，持续 8 秒。',
    ],
    colors: [1, 2],
  },
];
