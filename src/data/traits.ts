...
export const TRAITS: readonly TraitDef[] = [
  ...
  },
  {
    ...
    effectText: [
      ...
      '幽冥棋子首次阵亡时以 10% 生命复活，并获得 30% 攻速加成直至战斗结束；复活后 4 秒内受到的伤害增加 35%。',
    ],
    colors: [1, 2],
  },
  {
  ...
  },
  {
    ...
    effectText: [
      ...
      '构装体魔抗 +10；每次攻击叠加 12% 攻速（最多 8 层）；每第 4 次攻击额外造成 180% 攻击力的物理伤害。',
    ],
    colors: [1, 2],
  },
  {
...

  {
    ...
    effectText: [
      ...
      '所有友军获得 8% 全伤害减免；墨门棋子每秒回复 1.8% 最大生命。',
      '兼爱：友军受到的伤害有 30% 转由全体墨门棋子均摊；墨门棋子获得 20% 全伤害减免与 10% 最大生命。',
    ],
    colors: [0, 1, 2],
  },
  {
    ...
    effectText: [
      '兵家棋子攻击力 +20%。',
      '所有友军攻击力 +22%、攻速 +17%；攻击护甲 55 以上的目标时，附带 15% 攻击力的额外物理伤害。',
      '百战：任意友军击杀敌人时，全体友军永久 +26% 攻击力与 +18% 攻速；兵家棋子完成击杀时，全体友军永久 +52% 攻击力与 +36% 攻速。',
    ],
    colors: [0, 1, 2],
  },
  ...
  },
  {
    ...
    effectText: [
      ...
      '跃入后 5 秒内获得 35% 攻速；暴击伤害 +35%。跃入落定后立即突袭最近的敌人，造成其 12% 最大生命的物理伤害（不受伤害分摊）；对持有护盾的目标，攻击附带其 5% 最大生命的物理伤害。',
    ],
    colors: [1, 2],
  },
  {
